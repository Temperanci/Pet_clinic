                  ...
                  <el-row :gutter="20" align="middle">
                    ...
                    <el-col :span="2" style="width: 100%;">
                      <div>
                        ...
                        <!-- <p class="person-role">{{ tool.desc }}</p> -->
                      </div>
                    </el-col>
                  </el-row>
                </el-card>
...
const handleSelect = (department: DepartmentBO) => {
  ...
  if (department.name === "化验室") {
    toolList.value.push(({
      ...
      url: "/public/avatar/microscope.png"
    } as tool));
  }
  if (department.name === "手术室") {
    toolList.value.push(({
      ...
      url: "/public/avatar/operationboard.png"
    } as tool));
    toolList.value.push(({
      name: "氧气罐",
      ...
      url: "/public/avatar/yangqiguan.png"
    } as tool));
  }
};
